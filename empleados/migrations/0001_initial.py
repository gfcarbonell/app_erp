    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefijo_bis_vial', models.CharField(blank=True, choices=[('Bis', 'Bis'), ('No Bis', 'No Bis')], max_length=20, null=True)),
                ...
                ('prefijo_bis_numero_via_generadora', models.CharField(blank=True, choices=[('Bis', 'Bis'), ('No Bis', 'No Bis')], max_length=20, null=True)),
                ...
                ('complemento_ubicacion_predio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='complementos_ubicaciones_predios.ComplementoUbicacionPredio')),
                ('division_area_urbana', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='divisiones_areas_urbanas.DivisionAreaUrbana')),
                ...
                ('nucleo_residencial', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='nucleos_residenciales.NucleoResidencial')),
                ...
                ('tipo_predio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='tipos_predios.TipoPredio')),
                ('ubicacion_predio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='ubicaciones_predios.UbicacionPredio')),
