    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_letra_asociado_nombre_via', models.CharField(blank=True, max_length=20, null=True, verbose_name='N° Letra - Nombre (Zona/Vía)')),
                ('prefijo_bis_vial', models.CharField(blank=True, choices=[('Bis', 'Bis'), ('No Bis', 'No Bis')], max_length=20, null=True, verbose_name='Pref. Bis vial')),
                ('numero_letra_asociado_prefijo_bis_vial', models.CharField(blank=True, max_length=20, null=True, verbose_name='N° Letra - Pref. Bis vial')),
                ('cuadrante_vial', models.CharField(blank=True, choices=[('Este', 'Este'), ('Norte', 'Norte'), ('Oeste', 'Oeste'), ('Sur', 'Sur')], default=None, max_length=5, null=True)),
                ('numero_via_generadora', models.PositiveSmallIntegerField(blank=True, default=0, help_text='Escribir N° vía generadora.', verbose_name='N° vía generadora')),
                ('numero_letra_asociado_numero_via_generadora', models.CharField(blank=True, max_length=20, null=True, verbose_name='N° Letra - N° vía generadora')),
                ('prefijo_bis_numero_via_generadora', models.CharField(blank=True, choices=[('Bis', 'Bis'), ('No Bis', 'No Bis')], max_length=20, null=True, verbose_name='Pref. Bis N° vía generadora')),
                ('numero_letra_asociado_prefijo_bis_numero_via_generadora', models.CharField(blank=True, max_length=20, null=True, verbose_name='N° Letra - Pref. Bis N° vía generadora')),
                ...
                ('cuadrante_via_generadora', models.CharField(blank=True, choices=[('Este', 'Este'), ('Norte', 'Norte'), ('Oeste', 'Oeste'), ('Sur', 'Sur')], default=None, max_length=5, null=True)),
                ...
                ('nombre_tipo_predio', models.CharField(db_index=True, help_text='Escribir nombre del predio.', max_length=255, validators=[django.core.validators.MinLengthValidator(1), django.core.validators.MaxLengthValidator(255)], verbose_name='Nombre tipo predio')),
                ...
                ('complemento_ubicacion_tipo_predio', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='complementos_ubicaciones_predios.ComplementoUbicacionPredio')),
                ('division_area_urbana', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='divisiones_areas_urbanas.DivisionAreaUrbana')),
                ...
                ('nucleo_residencial', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='nucleos_residenciales.NucleoResidencial')),
                ...
                ('tipo_predio', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='tipos_predios.TipoPredio')),
                ('ubicacion_predio', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='empleados_empleado_related', to='ubicaciones_predios.UbicacionPredio')),
