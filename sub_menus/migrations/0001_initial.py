    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ultimo_usuario_editor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sub_menus_submenu_related', to=settings.AUTH_USER_MODEL)),
